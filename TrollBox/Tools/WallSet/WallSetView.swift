...
//                    Toggle("Downscale Images", isOn: $downscaleImages) // I don't think this is really necessary
            ...
            .modifier(WallSetViewAlerts(showingSelectAlert: $showingSelectAlert, showingErrorAlert: $showingErrorAlert))
...
struct WallSetViewAlerts: ViewModifier {
...
struct WallSet_Previews: PreviewProvider {
